        ...
        const rawObjectives = journeys.map((j) => {
            ...
            switch (mode) {
                ...
                case types_1.OptimizationMode.MOST_RELIABLE:
                    ...
                    break;
                case types_1.OptimizationMode.BALANCED:
                default:
...
exports.JourneyRanker = JourneyRanker;
