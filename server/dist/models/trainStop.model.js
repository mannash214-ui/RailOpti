...
exports.TrainStop = void 0;
const mongoose_1 = require("mongoose");
const timeFormatRegex = /^([0-1]?[0-9]|2[0-3]):[0-5][0-9]$/;
const trainStopSchema = new mongoose_1.Schema({
    trainId: {
...
exports.TrainStop = (0, mongoose_1.model)('TrainStop', trainStopSchema);
exports.default = exports.TrainStop;
